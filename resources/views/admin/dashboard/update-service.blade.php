...
<div class="col-lg-12">
    <div class="card">
        <div class="card-header"><h4>{{__('dashboard.edit service')}} </h4></div>
        <div class="card-body">
            <form accept-charset="utf-8" enctype="multipart/form-data" method="POST" action="{{route('service.update',$service->id)}}">
                ...
                <div class="form-group">
                    ...
                    <input name="artitle" type="text" placeholder=" " value="{{$service->artitle}}" class="form-control">
                    @error('artitle')
                ...
                <div class="form-group">
                    ...
                    <input name="entitle" type="text" placeholder=" " value="{{$service->entitle}}" class="form-control">
                    @error('entitle')
                    <p class="invalid-feedback d-block"> {{$message}}</p>
                    @enderror
                </div>
                ...
                <div class="form-group">
                  ...
                  <textarea id="ardes" name="ardes" class="form-control" cols="30" rows="10">{!!$service->ardes!!}</textarea>
                  ...
                  <textarea id="endes" name="endes" class="form-control" cols="30" rows="10">{!!$service->endes!!}</textarea>
