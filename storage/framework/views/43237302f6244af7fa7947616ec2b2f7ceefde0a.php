  ...
  <div class="card" style="width: 500px;">
    <div class="card-body">
      <div class="row no-gutters">
        <div class="col-sm-5">
          <div class="row align-items-center">
            <img class="img" width="50px"  src="<?php echo e(asset('uploads/images/1647425092_sms.png')); ?>" alt="sms">
            <div class="mx-3">
              <h5 class="card-title text-info mb-5">sms data</h5>
              
              <?php if($sms): ?>   <p class="card-text">
                <small class="text-muted"><i class="far fa-clock text-warning"></i>
                   <?php echo e($sms->updated_at->diffForHumans()); ?></small></p><?php endif; ?>
            </div>
...
<?php echo $__env->make('admin.layout.partials', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\taef-company\resources\views/admin/dashboard/marketing.blade.php ENDPATH**/ ?>