...
<div class="card mt-5 ml-5 mr-5 mb-5">
    ...
    <br>
    <div class="card-body">
        <form accept-charset="utf-8" enctype="multipart/form-data" method="POST" action="<?php echo e(route('sendMail2')); ?>">
            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.layout.partials', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\taef-company\resources\views/admin/dashboard/send-mail2.blade.php ENDPATH**/ ?>