...
class PartnersPolicy
{
    ...
    {
        return $user->hasAbility('partners.viewAny');
    }
    ...
    {
        return $user->hasAbility('partners.view');
    ...
    {
        return $user->hasAbility('partners.create');
    ...
    {
        return $user->hasAbility('partners.update');
    ...
    {
        return $user->hasAbility('partners.delete');
