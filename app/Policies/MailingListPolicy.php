...
class MailingListPolicy
{
    ...
    {
        return $user->hasAbility('mails.viewAny');
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function restore(User $user, MailingList $mailingList)
    {
        //
    }
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function forceDelete(User $user, MailingList $mailingList)
    {
        //
    }
}